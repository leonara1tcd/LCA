...
public class DAG {
	...
	private ArrayList<Integer>[] adj; // adjacency list for vertex v
	private int[] indegree; // indegree of vertex v
	private boolean marked[]; // Boolean array to track visited vertices
	...
	// Return amount of directed edges incident to vertex v
	...
	// Return amount of directed edges from vertex v
	...
	public int findLCA(int v, int w) {
		...
		// Reverse the DAG, allowing easier traversal
		...
		// cycling through the BFS paths, adding all common ancestors to the arrayList
		// return the first one found, as it is closest to the nodes
	...
	// to find the LCA, will have to traverse the graph backwards
	public DAG reverse() {
