...
public class DirectedCycle {
	...
	/**
	 * Determines whether the digraph has a directed cycle and, if so, finds such a
	 * cycle.
	 * 
	 * @param G the digraph
	 */
	...
	// check that the algorithm computes either the topological order or finds a
	// directed cycle
	...
	// certify digraph for a directed cycle if it reports one
